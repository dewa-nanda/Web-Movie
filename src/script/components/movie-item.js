  ...
  render() {
    ...
    <div class="col-xl-3 col-md-6 col-sm-12" style="margin-top: 12px;">
            <div class="item-card center-content-card card" style="width: 20rem; height: 100%">
                <img src="https://image.tmdb.org/t/p/w500/${this._movie.backdrop_path}" class="card-img-top " alt="Image not found">
                <div class="card-body">
                    <h5 class=" card-title text-center border-bottom fw-bolder">${this._movie.original_title}</h5>
                    <p class="card-text mt-4 pb-3 textCard fw-lighter textEdit">${this._movie.overview}</p>
                </div>
                <div class="container">
...
customElements.define('movie-item', itemMovie);
